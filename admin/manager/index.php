    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
			...
			<?php
				$query = mysqli_query($conn, "SELECT * FROM  pengguna WHERE id='$_SESSION[id]'");
      ...
      <div class="card mb-3">
          <div style="margin-left:30px" class="table-responsive">
            <?php
				...
				$query = mysqli_query($conn, "SELECT * FROM pengguna WHERE nama='$data[nama]'");
				$data = mysqli_fetch_array($query);	 
			?>
			<table>
				<tr>
					<th>Id Pengguna</th><th>&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;</th><th><?php echo $data['id']?></th>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
				...
				<tr>					
					<th>No Telepon</th><th>&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;</th><th><?php echo $data['no_telp']?></th>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
